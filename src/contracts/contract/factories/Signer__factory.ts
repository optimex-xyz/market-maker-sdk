...
import type { Signer, SignerInterface } from "../Signer";
...
export class Signer__factory {
  static readonly abi = _abi;
  static createInterface(): SignerInterface {
    return new Interface(_abi) as SignerInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Signer {
    return new Contract(address, _abi, runner) as unknown as Signer;
  }
}
