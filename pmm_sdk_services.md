...
// Single settlement
await solverService.submitSingleSettlement(tradeId, pmmId, settlementTx, signature, timestamp)

// Batch settlement
await solverService.submitBatchSettlement(tradeIds, pmmId, settlementTx, signature, startIndex, timestamp)
```
...
```typescript
import { getInfoHash, getSignature, SignatureType } from '@optimex-xyz/market-maker-sdk'
